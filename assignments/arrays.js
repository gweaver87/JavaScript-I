...
let lastMake = {
 ...
 // `${inventory[inventory.length - 1].car_make} ${inventory[inventory.length - 1].car_model}`;
console.log(lastMake);
...
let carModelsSorted = inventory[i].car_model;
carModels.push(carModelsSorted);
carModels.sort();
}
